...
//   listPrice: number;
//   description: string;
//   quantity: number; // Quản lý số lượng trong giỏ hàng
//   size: string;
//   color: string;
// }
            ...
            <div className="mt-8">
              <ul className="space-y-4">
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-base text-gray-900">Basic Tee 6-Pack</h3>
                  ...
                  <p className="text-base text-red-600 text-right w-[550px]">100.000 đ</p>
