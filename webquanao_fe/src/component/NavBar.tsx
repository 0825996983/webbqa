...
const location = useLocation();
  ...
  const toggleCart = () => {
    setIsCartOpen((prevState) => !prevState); // Toggle trạng thái giỏ hàng (mở/đóng)
  };
            ...
            <div className="container mx-auto flex items-center justify-between">
              ...
              <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                ...
                <div
                  ...
                  onMouseEnter={() => setIsHovered(true)} // Khi di chuột vào div bao quanh
                  onMouseLeave={() => setIsHovered(false)} // Khi di chuột ra khỏi div bao quanh
                >
                  <button
                    aria-label="go to cart"
                    ...
                    onClick={toggleCart} // Khi click vào giỏ hàng, sẽ chuyển trạng thái mở giỏ hàng
                  >
                    <svg
                      className="fill-stroke"
                      width={26}
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      onClick={() => setIsCartOpen(false)} // Close cart on click
                    >
                      <path
                  ...
                  {(isHovered || isCartOpen) && (
                    <div
                      ref={cartRef} // Add ref to the cart container to track clicks outside
                      className="absolute top-[-300px] right-0 z-50"
                      onMouseEnter={() => setIsHovered(true)}
                      onMouseLeave={() => setIsHovered(false)} // Close cart when mouse leaves
                    >
                      <div
